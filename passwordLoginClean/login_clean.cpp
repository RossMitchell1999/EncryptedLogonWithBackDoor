...
int main(int argc,char** argv) {
        (void)argc;										//Void argc to avoid unused variable warning
    string username = argv[1];							//Set username to first parameter
    string password = argv[2];							//Set password to second parameter
